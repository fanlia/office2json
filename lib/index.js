...
import { docx2json } from './docx/index.js'
import { pptx2json } from './pptx/index.js'
import { xlsx2json } from './xlsx/index.js'

import mime from 'mime'

export { xml2json, json2xml }

export const extract = (json, filepath) => {
  const handler = filepath.endsWith('.docx')
    ? docx2json
